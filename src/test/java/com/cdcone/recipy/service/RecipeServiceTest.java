...
public class RecipeServiceTest {
        ...
        public void init() {
                recipeService = new RecipeService(RECIPE_REPOSITORY,
                                RECIPE_FAVORITE_REPOSITORY, RECIPE_REACTION_SERVICE, RECIPE_VIEWED_SERVICE,
                                USER_SERVICE, TAG_SERVICE);
        }
        ...
        void successGetUserFavoriteRecipes() {
                ...
                Pair<String, PaginatedDto<UserRecipeResponseDto>> result2 = recipeService.getUserFavoriteRecipes(
                                "user1", false,
                                0, 0);
